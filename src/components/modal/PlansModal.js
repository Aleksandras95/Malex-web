    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <button onClick={this.open.bind(this)} className="btn btn-outline-secondary">Choose Plan</button>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body modal-body-centered">
                                <div className="plans-modal-content">
                                    <h3 className="modal-t-head after">Order 
                                <span className="modal-title-result"> {this.props.messageText}</span>
                                    </h3>
                                    <ModalPlansForm/>
