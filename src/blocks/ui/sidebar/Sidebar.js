...
const Sidebar = () => {
    ...
    return (
        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12" id="aside-sticky">
            <aside id="aside" className="widget-area">
                ...
                <div className="widget">
                    ...
                    <ul>
                        ...
                        <li>
                            <Link title="Slider" className="scroll-to-id" to="slider" spy={ true } smooth={ true } duration={ 0 } href="#slider">Carousel</Link>
                        </li>
